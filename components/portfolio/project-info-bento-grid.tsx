  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-6 gap-4 md:gap-6">
        ...
        {/* Action Buttons - Horizontal square buttons with negative hover effect */}
        {(portfolio.demoUrl || portfolio.repoUrl) && (
          <div className="md:col-span-2 group relative bg-white/80 dark:bg-gray-950/80 backdrop-blur-sm p-6 rounded-xl border border-gray-200/50 dark:border-gray-800/50 hover:border-indigo-300/50 dark:hover:border-indigo-700/50 transition-all duration-300 flex flex-row gap-3 items-center justify-center">
            {portfolio.demoUrl && (
              <a
                href={portfolio.demoUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="group/btn relative inline-flex items-center justify-center w-20 h-20 bg-white dark:bg-gray-900 border-2 border-indigo-600 dark:border-indigo-400 text-indigo-600 dark:text-indigo-400 rounded-xl overflow-hidden transition-all duration-300"
              >
                {/* Negative hover overlay - indigo circle that expands from center */}
                ...
                {/* Content */}
                <span className="relative flex flex-col items-center gap-1.5 z-10 transition-colors duration-300 group-hover/btn:text-white dark:group-hover/btn:text-white">

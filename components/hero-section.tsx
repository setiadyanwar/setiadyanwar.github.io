          ...
          >
            ...
            >
              <div className="relative">
                ...
                <div className="w-32 h-32 rounded-full overflow-hidden border border-white/20 dark:border-white/10 p-1 bg-white/20 dark:bg-black/20 backdrop-blur-2xl backdrop-saturate-150 shadow-2xl shadow-gray-200/20 dark:shadow-black/20"
                     style={{
              ...
              >
                <svg width="300" height="210" viewBox="0 0 194 87" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M14.4037 44.0056L7 6.28564L39.5763 25.1456L23.2882 29.4979L14.4037 44.0056Z" stroke="#5E6BF6" stroke-width="4" stroke-linecap="square"/>
                  </g>
                  <defs>
                  <filter id="filter0_d_2358_11385" x="0.898099" y="0.15342" width="47.1467" height="53.6601" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">

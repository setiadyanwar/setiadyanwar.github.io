      ...
      <div className="space-y-8 pb-20 animate-pulse">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
          <div className="space-y-2">
            ...
            <div className="h-4 w-80 bg-gray-100 dark:bg-gray-800/50 rounded-lg max-w-full" />
          </div>
          <div className="h-10 w-40 bg-indigo-100/50 dark:bg-indigo-900/20 rounded-xl" />
        </div>
          ...
          <div className="divide-y divide-gray-100 dark:divide-gray-800">
            {[1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="p-6 flex items-center gap-6">
                ...
                <div className="w-16 h-8 bg-gray-100 dark:bg-gray-800 rounded-lg" />
              </div>
            ))}
          </div>
        </div>
